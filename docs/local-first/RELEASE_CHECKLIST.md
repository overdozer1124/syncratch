...
(automated tip `d179efff59827007cd84664a52234f188e88cb1b`, 2026-07-22 JST;
docs refresh on main tip `eb045b9ce6d70bbbc16f023b176738813196636d`, 2026-07-29 JST).

Manual Google / remaining human checks:
`docs/local-first/STAGE5_MANUAL_GATES.md`.

Online re-probe (2026-07-29): Railway `/healthz` → `ok`; production bundle still
includes `drive.file` + APP_ID `863099193805`; online host hover phrase appears
once (see STAGE5 §C.1.1).
